...
import {createTaskValidator,
    ...
    updateSubTaskValidator} from "../validators/index.validator.js"
...
router
 ...
 .put( validateProjectPermission([
            UserRolesEnum.ADMIN,
            UserRolesEnum.PROJECT_ADMIN
        ]),updateTaskValidator(),validate,updateTask)
 .delete(
    validateProjectPermission([
        UserRolesEnum.ADMIN,
        UserRolesEnum.PROJECT_ADMIN
...
router
 ...
 .put(validateProjectPermission(AvailableUserRole),
